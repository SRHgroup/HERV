...
#### Barcode data 
All barcode output from the screenings is run with barracoda (https://services.healthtech.dtu.dk/service.php?Barracoda-1.8) where the output is merge into an Rdata file 
